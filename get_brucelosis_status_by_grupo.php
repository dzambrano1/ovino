...
try {
    ...
    $sql_groups = "SELECT DISTINCT grupo FROM ovino WHERE grupo IS NOT NULL AND grupo != '' ORDER BY grupo";
    ...
    $sql_counts = "
        SELECT
            ...
            COUNT(DISTINCT a.oh_brucelosis_tagid) AS vaccinated_animals
        FROM ovino v
        LEFT JOIN oh_brucelosis a ON v.tagid = a.oh_brucelosis_tagid
    ...
    $sql_list = "
        ...
        LEFT JOIN oh_brucelosis a ON v.tagid = a.oh_brucelosis_tagid
        WHERE v.grupo IS NOT NULL AND v.grupo != ''
          AND a.oh_brucelosis_tagid IS NULL
