...
try {
    ...
    $milkDataUrl = 'http://localhost/ovino/get_milk_revenue_data.php';
    ...
    $salesDataUrl = 'http://localhost/ovino/get_sales_data.php';
    ...
    $feedExpenses = [
        'concentrado' => ['table' => 'oh_concentrado', 'price_field' => 'oh_concentrado_costo', 'qty_field' => 'oh_concentrado_racion'],
        'melaza' => ['table' => 'oh_melaza', 'price_field' => 'oh_melaza_costo', 'qty_field' => 'oh_melaza_racion'],
        'sal' => ['table' => 'oh_sal', 'price_field' => 'oh_sal_costo', 'qty_field' => 'oh_sal_racion']
    ];
    ...
    $healthExpenses = [
        'oh_aftosa' => 'oh_aftosa_costo',
        'oh_brucelosis' => 'oh_brucelosis_costo', 
        'oh_clostridiosis' => 'oh_clostridiosis_costo',
        'oh_neumonia' => 'oh_neumonia_costo',
        'oh_ectima' => 'oh_ectima_costo',
        'oh_garrapatas' => 'oh_garrapatas_costo',
        'oh_parasitos' => 'oh_parasitos_costo'
    ];
