...
try {
    ...
    $vaccinatedQuery = "SELECT 
                            COUNT(DISTINCT a.oh_mastitis_tagid) AS vaccinated_animals
                        FROM ovino v 
                        LEFT JOIN oh_mastitis a ON v.tagid = a.oh_mastitis_tagid
                        WHERE v.grupo = ? AND a.oh_mastitis_tagid IS NOT NULL";
    ...
    $totalQuery = "SELECT COUNT(*) AS total_animals FROM ovino WHERE grupo = ?";
    ...
    $nonVaccinatedListQuery = "SELECT v.tagid, v.nombre 
                               FROM ovino v 
                               LEFT JOIN oh_mastitis a ON v.tagid = a.oh_mastitis_tagid
                               WHERE v.grupo = ? AND a.oh_mastitis_tagid IS NULL
