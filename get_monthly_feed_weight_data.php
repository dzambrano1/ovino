...
try {
    ...
    // *** IMPORTANT: Assumes ration weight column is oh_concentrado_racion ***
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $daily_feed_kg = (float)$row['oh_concentrado_racion']; // Get the daily ration weight
