...
try {
    // Query to get total monthly weight from oh_peso table
    // Assumes date column is oh_peso_fecha and weight column is oh_peso_animal	
    ...
    $sql = "
        ...
        FROM oh_peso 
        WHERE oh_peso_animal	 > 0 -- Optionally filter out zero or invalid weights
        GROUP BY month 
        ORDER BY month ASC;
    ";
