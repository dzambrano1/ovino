...
<title>Ovino Configuracion</title>
<!-- Link to the Favicon -->
...
<div class="container scroll-icons-container">
    ...
    <div class="container  salud-container" data-category="CONFIGURACION SALUD">
        <div class="icon-button-container">
            <button onclick="window.location.href='./ovino_configuracion_aftosa.php'" class="icon-button">
        ...
        <div class="icon-button-container">
            <button onclick="window.location.href='./ovino_configuracion_brucelosis.php'" class="icon-button">
        ...
        <div class="icon-button-container">
            <button onclick="window.location.href='./ovino_configuracion_clostridiosis.php'" class="icon-button">
        ...
        <div class="icon-button-container">
            <button onclick="window.location.href='./ovino_configuracion_neumonia.php'" class="icon-button">
                <img src="./images/neumonia.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label">NEUMONIA</span>
        </div>

        <div class="icon-button-container">
            <button onclick="window.location.href='./ovino_configuracion_ectima.php'" class="icon-button">
                <img src="./images/ectima.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label">ECTIMA</span>
        </div>

        <div class="icon-button-container">
            <button onclick="window.location.href='./ovino_configuracion_garrapatas.php'" class="icon-button">
        ...
        <div class="icon-button-container">
            <button onclick="window.location.href='./ovino_configuracion_parasitos.php'" class="icon-button">
    ...
    <div class="container  alimentacion-container" data-category="CONFIGURACION ALIMENTACION">
        <div class="icon-button-container">
            <button onclick="window.location.href='./ovino_configuracion_concentrado.php'" class="icon-button">
        ...
        <div class="icon-button-container">
            <button onclick="window.location.href='./ovino_configuracion_melaza.php'" class="icon-button">
        ...
        <div class="icon-button-container">
            <button onclick="window.location.href='./ovino_configuracion_sal.php'" class="icon-button">
    ...
    <div class="container  poblacion-container" data-category="CONFIGURACION POBLACION">
        <div class="icon-button-container">
            <button onclick="window.location.href='./ovino_configuracion_razas.php'" class="icon-button">
                <img src="./images/raza.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label">RAZAS</span>
        </div>
        <div class="icon-button-container">
            <button onclick="window.location.href='./ovino_configuracion_etapas.php'" class="icon-button">
                <img src="./images/etapas.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label">ETAPAS</span>
        </div>
        <div class="icon-button-container">
            <button onclick="window.location.href='./ovino_configuracion_grupos.php'" class="icon-button">
        ...
        <div class="icon-button-container">
            <button onclick="window.location.href='./ovino_configuracion_estatus.php'" class="icon-button">
