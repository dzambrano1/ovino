...
<title>Ovino Configuracion Aftosa</title>
<!-- Link to the Favicon -->
    ...
    <div class="container-fluid">
        <div class="row w-100">
            <div class="col-12 d-flex justify-content-center align-items-center">
                ...
                <i class="fas fa-syringe me-2"></i>CONFIGURACION AFTOSA<span class="ms-2"><i class="fas fa-shield-virus"></i></span>
                </h1>
            </div>
        </div>
    </div>
...
<div class="container my-3 text-center">
  <button type="button" class="btn btn-success text-center" data-bs-toggle="modal" data-bs-target="#newEntryModal">
    <i class="fas fa-plus-circle me-2"></i>Nueva Vacuna Aftosa
  </button>
</div>
...
<div class="modal fade" id="newEntryModal" tabindex="-1" aria-labelledby="newEntryModalLabel">
  ...
  <!-- DataTable for eh_aftosa records -->
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="aftosaTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $aftosaQuery = "SELECT * FROM oc_aftosa";
                      ...
                      if (empty($aftosasData)) {
                          ...
                          foreach ($aftosasData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-aftosa" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['oc_aftosa_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['oc_aftosa_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['oc_aftosa_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['oc_aftosa_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['oc_aftosa_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['oc_aftosa_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['oc_aftosa_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['oc_aftosa_vigencia'] ?? 'N/A') . "</td>";
