...
<title>Ovino Configuracion Brucelosis</title>
<!-- Link to the Favicon -->
    ...
    <div class="container-fluid">
        <div class="row w-100">
            <div class="col-12 d-flex justify-content-center align-items-center">
                ...
                <i class="fas fa-syringe me-2"></i>CONFIGURACION BRUCELOSIS<span class="ms-2"><i class="fas fa-bacteria"></i></span>
                </h1>
            </div>
        </div>
    </div>
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="brucelosisTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $brucelosisQuery = "SELECT * FROM oc_brucelosis";
                      ...
                      if (empty($brucelosissData)) {
                          ...
                          foreach ($brucelosissData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-brucelosis" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['oc_brucelosis_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['oc_brucelosis_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['oc_brucelosis_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['oc_brucelosis_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['oc_brucelosis_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['oc_brucelosis_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['oc_brucelosis_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['oc_brucelosis_vigencia'] ?? 'N/A') . "</td>";
