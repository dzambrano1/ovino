...
<title>Ovino Configuracion Clostridiosis</title>
<!-- Link to the Favicon -->
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="clostridiosisTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $clostridiosisQuery = "SELECT * FROM oc_clostridiosis";
                      ...
                      if (empty($clostridiosissData)) {
                          ...
                          foreach ($clostridiosissData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-clostridiosis" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['oc_clostridiosis_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['oc_clostridiosis_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['oc_clostridiosis_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['oc_clostridiosis_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['oc_clostridiosis_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['oc_clostridiosis_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['oc_clostridiosis_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['oc_clostridiosis_vigencia'] ?? 'N/A') . "</td>";
