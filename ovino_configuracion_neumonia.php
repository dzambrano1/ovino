...
<title>Ovino Configuracion Neumonia</title>
<!-- Link to the Favicon -->
...
<div class="container text-center">
  ...
  CONFIGURACION VACUNAS NEUMONIA
  </h3>
</div> 
...
<div class="container my-3 text-center">
  <button type="button" class="btn btn-success text-center" data-bs-toggle="modal" data-bs-target="#newEntryModal">
    <i class="fas fa-plus-circle me-2"></i>Nueva Vacuna Neumonia
  </button>
</div>
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="neumoniaTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $neumoniaQuery = "SELECT * FROM oc_neumonia";
                      ...
                      if (empty($neumoniasData)) {
                          ...
                          foreach ($neumoniasData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-neumonia" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['oc_neumonia_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['oc_neumonia_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['oc_neumonia_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['oc_neumonia_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['oc_neumonia_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['oc_neumonia_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['oc_neumonia_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['oc_neumonia_vigencia'] ?? 'N/A') . "</td>";
...
$(document).ready(function() {
    ...
    $('#saveNewNeumonia').click(function() {
        ...
        Swal.fire({
            ...
            text: `¿Desea registrar la dosis de neumonia ${formData.dosis} ml ?`,
            icon: 'question',
