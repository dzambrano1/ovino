...
$chartData = [];
try {
    $chartQuery = "SELECT DATE_FORMAT(oh_parto_fecha, '%Y-%m') as month_year, COUNT(*) as count 
                     FROM oh_parto 
                     GROUP BY month_year 
...
<title>Ovino Register Parto</title>
<!-- Link to the Favicon -->
...
<div class="container text-center">
  ...
  <!-- DataTable for oh_parto records -->
                  ...
                  try {
                      // Query to get all Female animals and their LATEST parto record (if any)
                        $partoQuery = "
                            SELECT
                                ...
                                ins.id AS parto_id,
                                ins.oh_parto_fecha,
                                ins.oh_parto_tagid, -- Will be NULL if no parto
                                ins.oh_parto_numero
                            FROM
                                ovino v
                            LEFT JOIN oh_parto ins
                              ON v.tagid = ins.oh_parto_tagid
                            LEFT JOIN oh_parto ins_check
                              ON ins.oh_parto_tagid = ins_check.oh_parto_tagid
                             AND ins.oh_parto_fecha < ins_check.oh_parto_fecha -- Check for a newer record
                            ...
                            ORDER BY
                                ...
                                ins.oh_parto_fecha DESC, -- Then by latest insemination date
                      ...
                      if (empty($partoData)) {
                          ...
                          foreach ($partoData as $row) {
                              ...
                              $partoFecha = $row['oh_parto_fecha'] ?? null;
                              ...
                              echo '<td class="text-center">
                                  <div class="btn-group" role="group">
                                      ...
                                      <button class="btn btn-warning btn-sm edit-parto" 
                                          ...
                                          data-numero="'.htmlspecialchars($row['oh_parto_numero'] ?? '').'" 
                              ...
                              echo "<td class='text-center'>" . ($hasparto ? htmlspecialchars($row['oh_parto_numero'] ?? '') : 'N/A') . "</td>";                              
