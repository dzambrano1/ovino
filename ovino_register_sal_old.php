                      ...
                      // Query to get all Animals and ALL their sal records (if any)
                        $salQuery = "
                            ...
                            FROM
                                ovino b
                            LEFT JOIN
                                oh_sal c ON b.tagid = c.oh_sal_tagid -- Join ALL matching sal records
                            ORDER BY
                          ...
                          foreach ($salData as $row) {
                              ...
                              if ($hasSal) {
                                  ...
                                  echo '        <button class="btn btn-warning btn-sm edit-sal" 
                                                  ...
                                                  data-etapa="'.htmlspecialchars($row['oh_sal_etapa'] ?? '').'" 
                              ...
                              echo "<td>" . ($hasSal ? htmlspecialchars($row['oh_sal_etapa'] ?? '') : 'N/A') . "</td>";
