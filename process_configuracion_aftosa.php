...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO oc_aftosa (oc_aftosa_vacuna, oc_aftosa_dosis, oc_aftosa_costo, oc_aftosa_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE oc_aftosa 
                    SET oc_aftosa_vacuna = :vacuna, 
                        oc_aftosa_dosis = :dosis, 
                        oc_aftosa_costo = :costo, 
                        oc_aftosa_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM oc_aftosa WHERE id = :id";
