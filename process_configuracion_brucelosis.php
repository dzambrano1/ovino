...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO oc_brucelosis (oc_brucelosis_vacuna, oc_brucelosis_dosis, oc_brucelosis_costo, oc_brucelosis_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE oc_brucelosis 
                    SET oc_brucelosis_vacuna = :vacuna, 
                        oc_brucelosis_dosis = :dosis, 
                        oc_brucelosis_costo = :costo, 
                        oc_brucelosis_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM oc_brucelosis WHERE id = :id";
