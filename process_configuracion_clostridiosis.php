...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO oc_clostridiosis (oc_clostridiosis_vacuna, oc_clostridiosis_dosis, oc_clostridiosis_costo, oc_clostridiosis_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE oc_clostridiosis 
                    SET oc_clostridiosis_vacuna = :vacuna, 
                        oc_clostridiosis_dosis = :dosis, 
                        oc_clostridiosis_costo = :costo, 
                        oc_clostridiosis_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM oc_clostridiosis WHERE id = :id";
