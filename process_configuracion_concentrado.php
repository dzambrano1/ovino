...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            $sql = "INSERT INTO oc_concentrado (oc_concentrado_nombre, oc_concentrado_etapa, oc_concentrado_costo, oc_concentrado_vigencia) 
        ...
        case 'update':
            ...
            // Update existing record in oc_concentrado
            $sql = "UPDATE oc_concentrado 
                    SET oc_concentrado_nombre = :concentrado, 
                        oc_concentrado_etapa = :etapa,
                        oc_concentrado_costo = :costo, 
                        oc_concentrado_vigencia = :vigencia 
                    WHERE id = :id";
            ...
            if (!$stmt->execute()) {
                throw new Exception("Error al actualizar el registro en oc_concentrado: " . implode(", ", $stmt->errorInfo()));
            }
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM oc_concentrado WHERE id = :id";
