...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO oc_ectima (oc_ectima_vacuna, oc_ectima_dosis, oc_ectima_costo, oc_ectima_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE oc_ectima 
                    SET oc_ectima_vacuna = :vacuna, 
                        oc_ectima_dosis = :dosis, 
                        oc_ectima_costo = :costo, 
                        oc_ectima_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM oc_ectima WHERE id = :id";
