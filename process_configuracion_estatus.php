...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO oc_estatus (oc_estatus_nombre) VALUES (:estatus)";
        ...
        case 'update':
            ...
            $sql = "UPDATE oc_estatus SET oc_estatus_nombre = :estatus WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM oc_estatus WHERE id = :id";
