...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO oc_garrapatas (oc_garrapatas_vacuna, oc_garrapatas_dosis, oc_garrapatas_costo, oc_garrapatas_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE oc_garrapatas 
                    SET oc_garrapatas_vacuna = :vacuna, 
                        oc_garrapatas_dosis = :dosis, 
                        oc_garrapatas_costo = :costo, 
                        oc_garrapatas_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM oc_garrapatas WHERE id = :id";
