...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO oc_grupos (oc_grupos_nombre) VALUES (:grupos)";
        ...
        case 'update':
            ...
            $sql = "UPDATE oc_grupos SET oc_grupos_nombre = :grupos WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM oc_grupos WHERE id = :id";
