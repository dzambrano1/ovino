...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            $sql = "INSERT INTO oc_melaza (oc_melaza_nombre, oc_melaza_etapa, oc_melaza_racion, oc_melaza_costo, oc_melaza_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE oc_melaza 
                    SET oc_melaza_nombre = :melaza, 
                        oc_melaza_etapa = :etapa,
                        oc_melaza_racion = :racion, 
                        oc_melaza_costo = :costo, 
                        oc_melaza_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM oc_melaza WHERE id = :id";
