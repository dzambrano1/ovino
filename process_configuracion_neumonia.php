...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO oc_neumonia (oc_neumonia_vacuna, oc_neumonia_dosis, oc_neumonia_costo, oc_neumonia_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE oc_neumonia 
                    SET oc_neumonia_vacuna = :vacuna, 
                        oc_neumonia_dosis = :dosis, 
                        oc_neumonia_costo = :costo, 
                        oc_neumonia_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM oc_neumonia WHERE id = :id";
