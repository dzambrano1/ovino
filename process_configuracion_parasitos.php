...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO oc_parasitos (oc_parasitos_vacuna, oc_parasitos_dosis, oc_parasitos_costo, oc_parasitos_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE oc_parasitos 
                    SET oc_parasitos_vacuna = :vacuna, 
                        oc_parasitos_dosis = :dosis, 
                        oc_parasitos_costo = :costo, 
                        oc_parasitos_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM oc_parasitos WHERE id = :id";
