...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            $sql = "INSERT INTO oc_sal (oc_sal_nombre, oc_sal_etapa, oc_sal_racion, oc_sal_costo, oc_sal_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE oc_sal 
                    SET oc_sal_nombre = :sal, 
                        oc_sal_etapa = :etapa,
                        oc_sal_racion = :racion, 
                        oc_sal_costo = :costo, 
                        oc_sal_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM oc_sal WHERE id = :id";
